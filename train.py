...
def main(args):
    ...
    for epoch in range(max(0, resume_epoch+1), args.epochs):
        ...
        if epoch >= save_interval_start and (epoch - save_interval_start) % save_interval == 0:
            utils.save_on_master(dict_to_save, os.path.join(args.output_dir, 'model_epoch_{}.pth'.format(epoch)))
