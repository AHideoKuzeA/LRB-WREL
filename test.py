...
def main(args):
    ...
    #single_model.load_state_dict(checkpoint['student_model'], strict=False)
    ...
    if args.model != 'lavt_one':
        ...
        bert_state = checkpoint['bert_model']

        bert_state = {k.replace('module.', ''): v for k, v in bert_state.items()}
        single_bert_model.load_state_dict(bert_state, strict=False)
