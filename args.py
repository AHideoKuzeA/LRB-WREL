...
def get_parser():
    ...
    parser.add_argument('--caption_lr', default=3e-5, type=float, help='the initial learning rate for caption')
    ...
    parser.add_argument('--caption_embedding_path', default='',
                        help='path to caption_embedding_path')
    ...
    parser.add_argument('--caption_inner_steps', default=1, type=int, help='number of inner steps for captioning')
    parser.add_argument('--caption_update_every', default=1, type=int, help='update caption bank every n steps')
    parser.add_argument('--start_epoch', default=1, type=int, help='update caption bank every n steps')


    parser.add_argument('--bank_refresh_every', default=1, type=int, help='update caption bank every n steps')
    parser.add_argument('--bank_refresh_epochs', default=1, type=int, help='update caption bank every n steps')
    parser.add_argument('--bank_refresh_start', default=1, type=int, help='update caption bank every n steps')
    parser.add_argument('--bank_refresh_lr', default=1e-6, type=float)
    return parser
